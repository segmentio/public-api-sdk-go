...
func main() {
    ...
    resp, r, err := apiClient.WarehousesAPI.AddConnectionFromSourceToWarehouse(context.Background(), warehouseId, sourceId).Execute()
    if err != nil {
...
func main() {
    createValidationInWarehouseV1Input := *openapiclient.NewCreateValidationInWarehouseV1Input("MetadataId_example", map[string]interface{}{"key": interface{}(123)}) // CreateValidationInWarehouseV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.WarehousesAPI.CreateValidationInWarehouse(context.Background()).CreateValidationInWarehouseV1Input(createValidationInWarehouseV1Input).Execute()
    if err != nil {
...
func main() {
    createWarehouseV1Input := *openapiclient.NewCreateWarehouseV1Input("MetadataId_example", map[string]interface{}{"key": interface{}(123)}) // CreateWarehouseV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.WarehousesAPI.CreateWarehouse(context.Background()).CreateWarehouseV1Input(createWarehouseV1Input).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.WarehousesAPI.DeleteWarehouse(context.Background(), warehouseId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.WarehousesAPI.GetConnectionStateFromWarehouse(context.Background(), warehouseId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.WarehousesAPI.ListConnectedSourcesFromWarehouse(context.Background(), warehouseId).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.WarehousesAPI.ListWarehouses(context.Background()).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.WarehousesAPI.RemoveSourceConnectionFromWarehouse(context.Background(), warehouseId, sourceId).Execute()
    if err != nil {
...
func main() {
    warehouseId := "kjU72LCJexvrqL7G4TMHHN" // string | 
    updateWarehouseV1Input := *openapiclient.NewUpdateWarehouseV1Input(map[string]interface{}{"key": interface{}(123)}) // UpdateWarehouseV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.WarehousesAPI.UpdateWarehouse(context.Background(), warehouseId).UpdateWarehouseV1Input(updateWarehouseV1Input).Execute()
    if err != nil {
