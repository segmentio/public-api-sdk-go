...
func main() {
    ...
    createFilterForDestinationV1Input := *openapiclient.NewCreateFilterForDestinationV1Input("SourceId_example", "If_example", []openapiclient.DestinationFilterActionV1{*openapiclient.NewDestinationFilterActionV1("Type_example")}, "Title_example", false) // CreateFilterForDestinationV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.DestinationFiltersAPI.CreateFilterForDestination(context.Background(), destinationId).CreateFilterForDestinationV1Input(createFilterForDestinationV1Input).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.DestinationFiltersAPI.GetFilterInDestination(context.Background(), destinationId, filterId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.DestinationFiltersAPI.ListFiltersFromDestination(context.Background(), destinationId).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    previewDestinationFilterV1Input := *openapiclient.NewPreviewDestinationFilterV1Input(*openapiclient.NewPreviewDestinationFilterV1("If_example", []openapiclient.DestinationFilterActionV1{*openapiclient.NewDestinationFilterActionV1("Type_example")}), map[string]interface{}{"key": interface{}(123)}) // PreviewDestinationFilterV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.DestinationFiltersAPI.PreviewDestinationFilter(context.Background()).PreviewDestinationFilterV1Input(previewDestinationFilterV1Input).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.DestinationFiltersAPI.RemoveFilterFromDestination(context.Background(), destinationId, filterId).Execute()
    if err != nil {
...
func main() {
    destinationId := "fP7qoQw2HTWt9WdMr718gn" // string | 
    filterId := "xx6AySGeFExzdv2Gw2EuhV" // string | 
    updateFilterForDestinationV1Input := *openapiclient.NewUpdateFilterForDestinationV1Input() // UpdateFilterForDestinationV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.DestinationFiltersAPI.UpdateFilterForDestination(context.Background(), destinationId, filterId).UpdateFilterForDestinationV1Input(updateFilterForDestinationV1Input).Execute()
    if err != nil {
