...
func main() {
    ...
    addSourceToTrackingPlanV1Input := *openapiclient.NewAddSourceToTrackingPlanV1Input("SourceId_example") // AddSourceToTrackingPlanV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.TrackingPlansAPI.AddSourceToTrackingPlan(context.Background(), trackingPlanId).AddSourceToTrackingPlanV1Input(addSourceToTrackingPlanV1Input).Execute()
    if err != nil {
...
func main() {
    createTrackingPlanV1Input := *openapiclient.NewCreateTrackingPlanV1Input("Name_example", "Type_example") // CreateTrackingPlanV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.TrackingPlansAPI.CreateTrackingPlan(context.Background()).CreateTrackingPlanV1Input(createTrackingPlanV1Input).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.TrackingPlansAPI.DeleteTrackingPlan(context.Background(), trackingPlanId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.TrackingPlansAPI.GetTrackingPlan(context.Background(), trackingPlanId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.TrackingPlansAPI.ListRulesFromTrackingPlan(context.Background(), trackingPlanId).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.TrackingPlansAPI.ListSourcesFromTrackingPlan(context.Background(), trackingPlanId).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.TrackingPlansAPI.ListTrackingPlans(context.Background()).Pagination(pagination).Type_(type_).Execute()
    if err != nil {
...
func main() {
    trackingPlanId := "tp_sprout_rVGCC6WdrNxjCf6JpCHP" // string | 
    rules := []openapiclient.RemoveRuleV1{[]openapiclient.RemoveRuleV1{*openapiclient.NewRemoveRuleV1("Type_example", float32(123))}} // []RemoveRuleV1 | Rules to delete.  This parameter exists in v1.

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.TrackingPlansAPI.RemoveRulesFromTrackingPlan(context.Background(), trackingPlanId).Rules(rules).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.TrackingPlansAPI.RemoveSourceFromTrackingPlan(context.Background(), trackingPlanId).SourceId(sourceId).Execute()
    if err != nil {
...
func main() {
    trackingPlanId := "tp_sprout_rVGCC6WdrNxjCf6JpCHP" // string | 
    replaceRulesInTrackingPlanV1Input := *openapiclient.NewReplaceRulesInTrackingPlanV1Input([]openapiclient.RuleInputV1{*openapiclient.NewRuleInputV1("Type_example", interface{}(123), float32(123))}) // ReplaceRulesInTrackingPlanV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.TrackingPlansAPI.ReplaceRulesInTrackingPlan(context.Background(), trackingPlanId).ReplaceRulesInTrackingPlanV1Input(replaceRulesInTrackingPlanV1Input).Execute()
    if err != nil {
...
func main() {
    trackingPlanId := "tp_sprout_rVGCC6WdrNxjCf6JpCHP" // string | 
    updateRulesInTrackingPlanV1Input := *openapiclient.NewUpdateRulesInTrackingPlanV1Input([]openapiclient.UpsertRuleV1{*openapiclient.NewUpsertRuleV1("Type_example", interface{}(123), float32(123))}) // UpdateRulesInTrackingPlanV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.TrackingPlansAPI.UpdateRulesInTrackingPlan(context.Background(), trackingPlanId).UpdateRulesInTrackingPlanV1Input(updateRulesInTrackingPlanV1Input).Execute()
    if err != nil {
...
func main() {
    trackingPlanId := "tp_sprout_rVGCC6WdrNxjCf6JpCHP" // string | 
    updateTrackingPlanV1Input := *openapiclient.NewUpdateTrackingPlanV1Input() // UpdateTrackingPlanV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.TrackingPlansAPI.UpdateTrackingPlan(context.Background(), trackingPlanId).UpdateTrackingPlanV1Input(updateTrackingPlanV1Input).Execute()
    if err != nil {
