...
func main() {
    ...
    createProfilesWarehouseAlphaInput := *openapiclient.NewCreateProfilesWarehouseAlphaInput("MetadataId_example", map[string]interface{}{"key": interface{}(123)}) // CreateProfilesWarehouseAlphaInput | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfilesSyncAPI.CreateProfilesWarehouse(context.Background(), spaceId).CreateProfilesWarehouseAlphaInput(createProfilesWarehouseAlphaInput).Execute()
    if err != nil {
...
func main() {
    spaceId := "9aQ1Lj62S4bomZKLF4DPqW" // string | 
    pagination := *openapiclient.NewPaginationInput(float32(123)) // PaginationInput | Defines the pagination parameters.  This parameter exists in alpha. (optional)

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfilesSyncAPI.ListProfilesWarehouseInSpace(context.Background(), spaceId).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfilesSyncAPI.ListSelectiveSyncsFromWarehouseAndSpace(context.Background(), spaceId, warehouseId).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfilesSyncAPI.RemoveProfilesWarehouseFromSpace(context.Background(), spaceId, warehouseId).Execute()
    if err != nil {
...
func main() {
    ...
    updateProfilesWarehouseForSpaceWarehouseAlphaInput := *openapiclient.NewUpdateProfilesWarehouseForSpaceWarehouseAlphaInput(map[string]interface{}{"key": interface{}(123)}) // UpdateProfilesWarehouseForSpaceWarehouseAlphaInput | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfilesSyncAPI.UpdateProfilesWarehouseForSpaceWarehouse(context.Background(), spaceId, warehouseId).UpdateProfilesWarehouseForSpaceWarehouseAlphaInput(updateProfilesWarehouseForSpaceWarehouseAlphaInput).Execute()
    if err != nil {
...
func main() {
    ...
    warehouseId := "kjU72LCJexvrqL7G4TMHHN" // string | 
    updateSelectiveSyncForWarehouseAndSpaceAlphaInput := *openapiclient.NewUpdateSelectiveSyncForWarehouseAndSpaceAlphaInput() // UpdateSelectiveSyncForWarehouseAndSpaceAlphaInput | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfilesSyncAPI.UpdateSelectiveSyncForWarehouseAndSpace(context.Background(), spaceId, warehouseId).UpdateSelectiveSyncForWarehouseAndSpaceAlphaInput(updateSelectiveSyncForWarehouseAndSpaceAlphaInput).Execute()
    if err != nil {
