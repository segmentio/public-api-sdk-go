...
func main() {
    ...
    resp, r, err := apiClient.ComputedTraitsAPI.GetComputedTrait(context.Background(), spaceId, id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.ComputedTraitsAPI.ListComputedTraits(context.Background(), spaceId).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.ComputedTraitsAPI.RemoveComputedTraitFromSpace(context.Background(), spaceId, id).Execute()
    if err != nil {
...
func main() {
    spaceId := "spaceId" // string | 
    id := "id" // string | 
    updateComputedTraitForSpaceAlphaInput := *openapiclient.NewUpdateComputedTraitForSpaceAlphaInput(false) // UpdateComputedTraitForSpaceAlphaInput | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.ComputedTraitsAPI.UpdateComputedTraitForSpace(context.Background(), spaceId, id).UpdateComputedTraitForSpaceAlphaInput(updateComputedTraitForSpaceAlphaInput).Execute()
    if err != nil {
