...
func main() {
    ...
    createAudienceBetaInput := *api.NewCreateAudienceBetaInput("Name_example", *api.NewComputeConditionsWrapper("Format_example", map[string]interface{}(123)), "ProductVariant_example") // CreateAudienceBetaInput | 
