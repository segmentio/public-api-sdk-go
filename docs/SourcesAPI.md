...
func main() {
    ...
    addLabelsToSourceV1Input := *openapiclient.NewAddLabelsToSourceV1Input([]openapiclient.LabelV1{*openapiclient.NewLabelV1("Key_example", "Value_example")}) // AddLabelsToSourceV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesAPI.AddLabelsToSource(context.Background(), sourceId).AddLabelsToSourceV1Input(addLabelsToSourceV1Input).Execute()
    if err != nil {
...
func main() {
    createSourceV1Input := *openapiclient.NewCreateSourceV1Input("Slug_example", false, "MetadataId_example") // CreateSourceV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesAPI.CreateSource(context.Background()).CreateSourceV1Input(createSourceV1Input).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesAPI.DeleteSource(context.Background(), sourceId).Execute()
    if err != nil {
...
func main() {
    sourceId := "qQEHquLrjRDN9j1ByrChyn" // string | 
    pagination := *openapiclient.NewPaginationInput(float32(123)) // PaginationInput | Required pagination params for the request.  This parameter exists in alpha.

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesAPI.ListConnectedDestinationsFromSource(context.Background(), sourceId).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesAPI.ListConnectedWarehousesFromSource(context.Background(), sourceId).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesAPI.ListSchemaSettingsInSource(context.Background(), sourceId).Execute()
    if err != nil {
...
func main() {
    pagination := *openapiclient.NewPaginationInput(float32(123)) // PaginationInput | Defines the pagination parameters.  This parameter exists in alpha.

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesAPI.ListSources(context.Background()).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    sourceId := "rh5BDZp6QDHvXFCkibm1pR" // string | 
    replaceLabelsInSourceV1Input := *openapiclient.NewReplaceLabelsInSourceV1Input([]openapiclient.LabelV1{*openapiclient.NewLabelV1("Key_example", "Value_example")}) // ReplaceLabelsInSourceV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesAPI.ReplaceLabelsInSource(context.Background(), sourceId).ReplaceLabelsInSourceV1Input(replaceLabelsInSourceV1Input).Execute()
    if err != nil {
...
func main() {
    sourceId := "qQEHquLrjRDN9j1ByrChyn" // string | 
    updateSchemaSettingsInSourceV1Input := *openapiclient.NewUpdateSchemaSettingsInSourceV1Input() // UpdateSchemaSettingsInSourceV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesAPI.UpdateSchemaSettingsInSource(context.Background(), sourceId).UpdateSchemaSettingsInSourceV1Input(updateSchemaSettingsInSourceV1Input).Execute()
    if err != nil {
...
func main() {
    ...
    updateSourceV1Input := *openapiclient.NewUpdateSourceV1Input() // UpdateSourceV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SourcesAPI.UpdateSource(context.Background(), sourceId).UpdateSourceV1Input(updateSourceV1Input).Execute()
    if err != nil {
