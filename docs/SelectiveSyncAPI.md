...
func main() {
    ...
    resp, r, err := apiClient.SelectiveSyncAPI.GetAdvancedSyncScheduleFromWarehouse(context.Background(), warehouseId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SelectiveSyncAPI.ListSelectiveSyncsFromWarehouseAndSource(context.Background(), warehouseId, sourceId).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SelectiveSyncAPI.ListSyncsFromWarehouse(context.Background(), warehouseId).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SelectiveSyncAPI.ListSyncsFromWarehouseAndSource(context.Background(), warehouseId, sourceId).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    warehouseId := "kjU72LCJexvrqL7G4TMHHN" // string | 
    replaceAdvancedSyncScheduleForWarehouseV1Input := *openapiclient.NewReplaceAdvancedSyncScheduleForWarehouseV1Input(false) // ReplaceAdvancedSyncScheduleForWarehouseV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SelectiveSyncAPI.ReplaceAdvancedSyncScheduleForWarehouse(context.Background(), warehouseId).ReplaceAdvancedSyncScheduleForWarehouseV1Input(replaceAdvancedSyncScheduleForWarehouseV1Input).Execute()
    if err != nil {
...
func main() {
    warehouseId := "kjU72LCJexvrqL7G4TMHHN" // string | 
    updateSelectiveSyncForWarehouseV1Input := *openapiclient.NewUpdateSelectiveSyncForWarehouseV1Input([]openapiclient.WarehouseSyncOverrideV1{*openapiclient.NewWarehouseSyncOverrideV1("SourceId_example", false)}) // UpdateSelectiveSyncForWarehouseV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SelectiveSyncAPI.UpdateSelectiveSyncForWarehouse(context.Background(), warehouseId).UpdateSelectiveSyncForWarehouseV1Input(updateSelectiveSyncForWarehouseV1Input).Execute()
    if err != nil {
