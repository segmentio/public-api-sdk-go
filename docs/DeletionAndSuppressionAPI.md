...
func main() {
    ...
    createCloudSourceRegulationV1Input := *openapiclient.NewCreateCloudSourceRegulationV1Input("RegulationType_example", "SubjectType_example", []string{"SubjectIds_example"}, "Collection_example") // CreateCloudSourceRegulationV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.DeletionAndSuppressionAPI.CreateCloudSourceRegulation(context.Background(), sourceId).CreateCloudSourceRegulationV1Input(createCloudSourceRegulationV1Input).Execute()
    if err != nil {
...
func main() {
    sourceId := "qQEHquLrjRDN9j1ByrChyn" // string | 
    createSourceRegulationV1Input := *openapiclient.NewCreateSourceRegulationV1Input("RegulationType_example", "SubjectType_example", []string{"SubjectIds_example"}) // CreateSourceRegulationV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.DeletionAndSuppressionAPI.CreateSourceRegulation(context.Background(), sourceId).CreateSourceRegulationV1Input(createSourceRegulationV1Input).Execute()
    if err != nil {
...
func main() {
    createWorkspaceRegulationV1Input := *openapiclient.NewCreateWorkspaceRegulationV1Input("RegulationType_example", "SubjectType_example", []string{"SubjectIds_example"}) // CreateWorkspaceRegulationV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.DeletionAndSuppressionAPI.CreateWorkspaceRegulation(context.Background()).CreateWorkspaceRegulationV1Input(createWorkspaceRegulationV1Input).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.DeletionAndSuppressionAPI.DeleteRegulation(context.Background(), regulateId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.DeletionAndSuppressionAPI.GetRegulation(context.Background(), regulateId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.DeletionAndSuppressionAPI.ListRegulationsFromSource(context.Background(), sourceId).Pagination(pagination).Status(status).RegulationTypes(regulationTypes).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.DeletionAndSuppressionAPI.ListSuppressions(context.Background()).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.DeletionAndSuppressionAPI.ListWorkspaceRegulations(context.Background()).Pagination(pagination).Status(status).RegulationTypes(regulationTypes).Execute()
    if err != nil {
