...
func main() {
    ...
    batchQueryMessagingSubscriptionsForSpaceAlphaInput := *openapiclient.NewBatchQueryMessagingSubscriptionsForSpaceAlphaInput([]openapiclient.GetSubscriptionRequest{*openapiclient.NewGetSubscriptionRequest("Key_example", "Type_example")}) // BatchQueryMessagingSubscriptionsForSpaceAlphaInput | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SpacesAPI.BatchQueryMessagingSubscriptionsForSpace(context.Background(), spaceId).BatchQueryMessagingSubscriptionsForSpaceAlphaInput(batchQueryMessagingSubscriptionsForSpaceAlphaInput).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SpacesAPI.GetSpace(context.Background(), spaceId).Execute()
    if err != nil {
...
func main() {
    spaceId := "9aQ1Lj62S4bomZKLF4DPqW" // string | 
    replaceMessagingSubscriptionsInSpacesAlphaInput := *openapiclient.NewReplaceMessagingSubscriptionsInSpacesAlphaInput([]openapiclient.MessagesSubscriptionRequest{*openapiclient.NewMessagesSubscriptionRequest("Key_example", "Type_example")}) // ReplaceMessagingSubscriptionsInSpacesAlphaInput | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.SpacesAPI.ReplaceMessagingSubscriptionsInSpaces(context.Background(), spaceId).ReplaceMessagingSubscriptionsInSpacesAlphaInput(replaceMessagingSubscriptionsInSpacesAlphaInput).Execute()
    if err != nil {
