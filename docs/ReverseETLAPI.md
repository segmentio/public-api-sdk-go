...
func main() {
    createReverseEtlModelInput := *openapiclient.NewCreateReverseEtlModelInput("SourceId_example", "Name_example", "Description_example", false, "ScheduleStrategy_example", map[string]interface{}{"key": interface{}(123)}, "Query_example", "QueryIdentifierColumn_example") // CreateReverseEtlModelInput | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.ReverseETLAPI.CreateReverseEtlModel(context.Background()).CreateReverseEtlModelInput(createReverseEtlModelInput).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.ReverseETLAPI.DeleteReverseEtlModel(context.Background(), modelId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.ReverseETLAPI.GetReverseEtlModel(context.Background(), modelId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.ReverseETLAPI.ListReverseEtlModels(context.Background()).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    ...
    updateReverseEtlModelInput := *openapiclient.NewUpdateReverseEtlModelInput() // UpdateReverseEtlModelInput | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.ReverseETLAPI.UpdateReverseEtlModel(context.Background(), modelId).UpdateReverseEtlModelInput(updateReverseEtlModelInput).Execute()
    if err != nil {
