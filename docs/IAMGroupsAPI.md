...
func main() {
    ...
    addPermissionsToUserGroupV1Input := *openapiclient.NewAddPermissionsToUserGroupV1Input([]openapiclient.PermissionInputV1{*openapiclient.NewPermissionInputV1("RoleId_example", []openapiclient.PermissionResourceV1{*openapiclient.NewPermissionResourceV1("Id_example", "Type_example")})}) // AddPermissionsToUserGroupV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.IAMGroupsAPI.AddPermissionsToUserGroup(context.Background(), userGroupId).AddPermissionsToUserGroupV1Input(addPermissionsToUserGroupV1Input).Execute()
    if err != nil {
...
func main() {
    userGroupId := "bBABwqbaDf2QdwTbW8bNEm" // string | 
    addUsersToUserGroupV1Input := *openapiclient.NewAddUsersToUserGroupV1Input([]string{"Emails_example"}) // AddUsersToUserGroupV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.IAMGroupsAPI.AddUsersToUserGroup(context.Background(), userGroupId).AddUsersToUserGroupV1Input(addUsersToUserGroupV1Input).Execute()
    if err != nil {
...
func main() {
    createUserGroupV1Input := *openapiclient.NewCreateUserGroupV1Input("Name_example") // CreateUserGroupV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.IAMGroupsAPI.CreateUserGroup(context.Background()).CreateUserGroupV1Input(createUserGroupV1Input).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.IAMGroupsAPI.DeleteUserGroup(context.Background(), userGroupId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.IAMGroupsAPI.GetUserGroup(context.Background(), userGroupId).Execute()
    if err != nil {
...
func main() {
    userGroupId := "bBABwqbaDf2QdwTbW8bNEm" // string | 
    pagination := *openapiclient.NewPaginationInput(float32(123)) // PaginationInput | Pagination for invites to the group.  This parameter exists in v1.

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.IAMGroupsAPI.ListInvitesFromUserGroup(context.Background(), userGroupId).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    pagination := *openapiclient.NewPaginationInput(float32(123)) // PaginationInput | Pagination for user groups.  This parameter exists in v1.

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.IAMGroupsAPI.ListUserGroups(context.Background()).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    userGroupId := "bBABwqbaDf2QdwTbW8bNEm" // string | 
    pagination := *openapiclient.NewPaginationInput(float32(123)) // PaginationInput | Pagination for members of a group.  This parameter exists in v1.

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.IAMGroupsAPI.ListUsersFromUserGroup(context.Background(), userGroupId).Pagination(pagination).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.IAMGroupsAPI.RemoveUsersFromUserGroup(context.Background(), userGroupId).Emails(emails).Execute()
    if err != nil {
...
func main() {
    userGroupId := "bBABwqbaDf2QdwTbW8bNEm" // string | 
    replacePermissionsForUserGroupV1Input := *openapiclient.NewReplacePermissionsForUserGroupV1Input([]openapiclient.PermissionInputV1{*openapiclient.NewPermissionInputV1("RoleId_example", []openapiclient.PermissionResourceV1{*openapiclient.NewPermissionResourceV1("Id_example", "Type_example")})}) // ReplacePermissionsForUserGroupV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.IAMGroupsAPI.ReplacePermissionsForUserGroup(context.Background(), userGroupId).ReplacePermissionsForUserGroupV1Input(replacePermissionsForUserGroupV1Input).Execute()
    if err != nil {
...
func main() {
    userGroupId := "bBABwqbaDf2QdwTbW8bNEm" // string | 
    replaceUsersInUserGroupV1Input := *openapiclient.NewReplaceUsersInUserGroupV1Input([]string{"Emails_example"}) // ReplaceUsersInUserGroupV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.IAMGroupsAPI.ReplaceUsersInUserGroup(context.Background(), userGroupId).ReplaceUsersInUserGroupV1Input(replaceUsersInUserGroupV1Input).Execute()
    if err != nil {
...
func main() {
    userGroupId := "bBABwqbaDf2QdwTbW8bNEm" // string | 
    updateUserGroupV1Input := *openapiclient.NewUpdateUserGroupV1Input("Name_example") // UpdateUserGroupV1Input | 

    configuration := api.NewConfiguration()
    apiClient := api.NewAPIClient(configuration)
    resp, r, err := apiClient.IAMGroupsAPI.UpdateUserGroup(context.Background(), userGroupId).UpdateUserGroupV1Input(updateUserGroupV1Input).Execute()
    if err != nil {
