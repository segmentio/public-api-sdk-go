...
// checks if the AddConnectionFromSourceToWarehouseV1Output type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddConnectionFromSourceToWarehouseV1Output{}
...
func (v *NullableAddConnectionFromSourceToWarehouseV1Output) Set(
	val *AddConnectionFromSourceToWarehouseV1Output,
) {
	v.value = val
	v.isSet = true
}
...
func NewNullableAddConnectionFromSourceToWarehouseV1Output(
	val *AddConnectionFromSourceToWarehouseV1Output,
) *NullableAddConnectionFromSourceToWarehouseV1Output {
