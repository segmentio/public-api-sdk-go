...
func NewListConnectedWarehousesFromSourceAlphaOutput(warehouses []WarehouseV1, pagination Pagination) *ListConnectedWarehousesFromSourceAlphaOutput {
...
func (v *NullableListConnectedWarehousesFromSourceAlphaOutput) Set(val *ListConnectedWarehousesFromSourceAlphaOutput) {
	v.value = val
	v.isSet = true
}
...
func NewNullableListConnectedWarehousesFromSourceAlphaOutput(val *ListConnectedWarehousesFromSourceAlphaOutput) *NullableListConnectedWarehousesFromSourceAlphaOutput {
