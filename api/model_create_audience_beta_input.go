...
type CreateAudienceBetaInput struct {
	...
	ComputeConditionsWrapper ComputeConditionsWrapper `json:"computeConditionsWrapper"`
...
// GetComputeConditionsWrapper returns the ComputeConditionsWrapper field value
func (o *CreateAudienceBetaInput) GetComputeConditionsWrapper() ComputeConditionsWrapper {
	if o == nil {
		var ret ComputeConditionsWrapper
		return ret
	}

	return o.ComputeConditionsWrapper
}

// GetComputeConditionsWrapperOk returns a tuple with the ComputeConditionsWrapper field value
// and a boolean to check if the value has been set.
func (o *CreateAudienceBetaInput) GetComputeConditionsWrapperOk() (*ComputeConditionsWrapper, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ComputeConditionsWrapper, true
}

// SetComputeConditionsWrapper sets field value
func (o *CreateAudienceBetaInput) SetComputeConditionsWrapper(v ComputeConditionsWrapper) {
	o.ComputeConditionsWrapper = v
}

// GetProductVariant returns the ProductVariant field value
func (o *CreateAudienceBetaInput) GetProductVariant() string {
	if o == nil {
		var ret string
		return ret
	}
...
// GetProductVariantOk returns a tuple with the ProductVariant field value
// and a boolean to check if the value has been set.
func (o *CreateAudienceBetaInput) GetProductVariantOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// SetProductVariant sets field value
func (o *CreateAudienceBetaInput) SetProductVariant(v string) {
	o.ProductVariant = v
}
...
func (o *CreateAudienceBetaInput) GetTargetEntity() string {
...
// and a boolean to check if the value has been set.
func (o *CreateAudienceBetaInput) GetTargetEntityOk() (*string, bool) {
	if o == nil || IsNil(o.TargetEntity) {
		return nil, false
	}
...
func (o *CreateAudienceBetaInput) HasTargetEntity() bool {
	if o != nil && !IsNil(o.TargetEntity) {
		return true
	}
...
func (o *CreateAudienceBetaInput) SetTargetEntity(v string) {
	o.TargetEntity = &v
}
...
func (o CreateAudienceBetaInput) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["computeConditionsWrapper"] = o.ComputeConditionsWrapper
