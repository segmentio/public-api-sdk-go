...
*/
func (a *SelectiveSyncApiService) ListSelectiveSyncsFromWarehouseAndSpace(
	ctx context.Context,
	spaceId string,
	warehouseId string,
) ApiListSelectiveSyncsFromWarehouseAndSpaceRequest {
...
func (a *SelectiveSyncApiService) ListSelectiveSyncsFromWarehouseAndSpaceExecute(
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(
		r.ctx,
		"SelectiveSyncApiService.ListSelectiveSyncsFromWarehouseAndSpace",
	)
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
