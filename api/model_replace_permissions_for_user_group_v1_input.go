...
func NewReplacePermissionsForUserGroupV1Input() *ReplacePermissionsForUserGroupV1Input {
...
func (o *ReplacePermissionsForUserGroupV1Input) HasPermissions() bool {
	if o != nil && o.Permissions != nil {
		return true
	}
...
func (v *NullableReplacePermissionsForUserGroupV1Input) Set(val *ReplacePermissionsForUserGroupV1Input) {
	v.value = val
	v.isSet = true
}
...
func NewNullableReplacePermissionsForUserGroupV1Input(val *ReplacePermissionsForUserGroupV1Input) *NullableReplacePermissionsForUserGroupV1Input {
