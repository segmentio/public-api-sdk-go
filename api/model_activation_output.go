...
func (o *ActivationOutput) GetPerformFirstSync() bool {
...
// and a boolean to check if the value has been set.
func (o *ActivationOutput) GetPerformFirstSyncOk() (*bool, bool) {
	if o == nil || IsNil(o.PerformFirstSync) {
		return nil, false
	}
...
func (o *ActivationOutput) HasPerformFirstSync() bool {
	if o != nil && !IsNil(o.PerformFirstSync) {
		return true
	}
...
func (o *ActivationOutput) SetPerformFirstSync(v bool) {
