...
func NewListConnectedWarehousesFromSourceV1Output(warehouses []WarehouseV1, pagination Pagination) *ListConnectedWarehousesFromSourceV1Output {
...
func (o *ListConnectedWarehousesFromSourceV1Output) GetPagination() Pagination {
	if o == nil {
		var ret Pagination
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListConnectedWarehousesFromSourceV1Output) GetPaginationOk() (*Pagination, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ListConnectedWarehousesFromSourceV1Output) SetPagination(v Pagination) {
	o.Pagination = v
}
...
func (v *NullableListConnectedWarehousesFromSourceV1Output) Set(val *ListConnectedWarehousesFromSourceV1Output) {
	v.value = val
	v.isSet = true
}
...
func NewNullableListConnectedWarehousesFromSourceV1Output(val *ListConnectedWarehousesFromSourceV1Output) *NullableListConnectedWarehousesFromSourceV1Output {
