...
func NewErrorsInner(audienceId string, message string) *ErrorsInner {
	this := ErrorsInner{}
...
func (o *ErrorsInner) GetAudienceId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ErrorsInner) GetAudienceIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ErrorsInner) SetAudienceId(v string) {
	o.AudienceId = v
}
