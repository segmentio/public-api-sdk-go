...
func NewListUserGroupsV1Output(userGroups []UserGroupV1, pagination Pagination) *ListUserGroupsV1Output {
...
func (o *ListUserGroupsV1Output) GetPagination() Pagination {
	if o == nil {
		var ret Pagination
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListUserGroupsV1Output) GetPaginationOk() (*Pagination, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ListUserGroupsV1Output) SetPagination(v Pagination) {
	o.Pagination = v
}
...
func NewNullableListUserGroupsV1Output(val *ListUserGroupsV1Output) *NullableListUserGroupsV1Output {
