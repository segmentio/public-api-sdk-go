...
// Source1 The returned Source object.
type Source1 struct {
...
func NewSource1(id string, slug string, metadata Metadata1, workspaceId string, enabled bool, writeKeys []string, labels []LabelV1) *Source1 {
	this := Source1{}
	this.Id = id
	this.Slug = slug
...
// and a boolean to check if the value has been set.
func (o *Source1) GetSlugOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Slug, true
...
func (o *Source1) SetSlug(v string) {
	o.Slug = v
}
...
func (o *Source1) GetMetadata() Metadata1 {
	if o == nil {
		var ret Metadata1
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Source1) GetMetadataOk() (*Metadata1, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Source1) SetMetadata(v Metadata1) {
	o.Metadata = v
}

// GetWorkspaceId returns the WorkspaceId field value
func (o *Source1) GetWorkspaceId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Source1) GetWorkspaceIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Source1) SetWorkspaceId(v string) {
	o.WorkspaceId = v
}

// GetEnabled returns the Enabled field value
func (o *Source1) GetEnabled() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Source1) GetEnabledOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Source1) SetEnabled(v bool) {
	o.Enabled = v
}

// GetWriteKeys returns the WriteKeys field value
func (o *Source1) GetWriteKeys() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Source1) GetWriteKeysOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Source1) SetWriteKeys(v []string) {
	o.WriteKeys = v
}

// GetSettings returns the Settings field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Source1) GetSettings() ModelMap {
...
func (o *Source1) GetSettingsOk() (*ModelMap, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Source1) HasSettings() bool {
...
func (o *Source1) SetSettings(v ModelMap) {
	o.Settings.Set(&v)
}
// SetSettingsNil sets the value for Settings to be an explicit nil
func (o *Source1) SetSettingsNil() {
	o.Settings.Set(nil)
}

// UnsetSettings ensures that no value is present for Settings, not even an explicit nil
func (o *Source1) UnsetSettings() {
	o.Settings.Unset()
}

// GetLabels returns the Labels field value
func (o *Source1) GetLabels() []LabelV1 {
	if o == nil {
		var ret []LabelV1
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Source1) GetLabelsOk() ([]LabelV1, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Source1) SetLabels(v []LabelV1) {
	o.Labels = v
}
