...
func (o *ListAudiencesAlphaOutput) GetPagination() Pagination {
	if o == nil {
		var ret Pagination
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListAudiencesAlphaOutput) GetPaginationOk() (*Pagination, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ListAudiencesAlphaOutput) SetPagination(v Pagination) {
	o.Pagination = v
}
