...
func NewCreateDestinationSubscriptionAlphaOutput(destinationSubscription DestinationSubscription) *CreateDestinationSubscriptionAlphaOutput {
...
func (o *CreateDestinationSubscriptionAlphaOutput) SetDestinationSubscription(v DestinationSubscription) {
...
func (v *NullableCreateDestinationSubscriptionAlphaOutput) Set(val *CreateDestinationSubscriptionAlphaOutput) {
	v.value = val
	v.isSet = true
}
...
func NewNullableCreateDestinationSubscriptionAlphaOutput(val *CreateDestinationSubscriptionAlphaOutput) *NullableCreateDestinationSubscriptionAlphaOutput {
