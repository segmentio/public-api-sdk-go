...
func NewRemoveSourceConnectionFromWarehouseV1Output(status string) *RemoveSourceConnectionFromWarehouseV1Output {
...
func (v *NullableRemoveSourceConnectionFromWarehouseV1Output) Set(val *RemoveSourceConnectionFromWarehouseV1Output) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRemoveSourceConnectionFromWarehouseV1Output(val *RemoveSourceConnectionFromWarehouseV1Output) *NullableRemoveSourceConnectionFromWarehouseV1Output {
