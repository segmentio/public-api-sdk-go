...
type ReverseEtlScheduleDefinition struct {
	...
	Config   ReverseEtlScheduleConfig `json:"config"`
}
...
func (o *ReverseEtlScheduleDefinition) GetConfig() ReverseEtlScheduleConfig {
	if o == nil {
		var ret ReverseEtlScheduleConfig
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ReverseEtlScheduleDefinition) GetConfigOk() (*ReverseEtlScheduleConfig, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ReverseEtlScheduleDefinition) SetConfig(v ReverseEtlScheduleConfig) {
	o.Config = v
}
