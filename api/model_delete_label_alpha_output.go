...
// checks if the DeleteLabelAlphaOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteLabelAlphaOutput{}
...
// NewDeleteLabelAlphaOutput instantiates a new DeleteLabelAlphaOutput object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDeleteLabelAlphaOutput(status string) *DeleteLabelAlphaOutput {
	this := DeleteLabelAlphaOutput{}
	this.Status = status
	return &this
}

// NewDeleteLabelAlphaOutputWithDefaults instantiates a new DeleteLabelAlphaOutput object
...
type NullableDeleteLabelAlphaOutput struct {
	value *DeleteLabelAlphaOutput
	isSet bool
}

func (v NullableDeleteLabelAlphaOutput) Get() *DeleteLabelAlphaOutput {
	return v.value
}

func (v *NullableDeleteLabelAlphaOutput) Set(val *DeleteLabelAlphaOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteLabelAlphaOutput) IsSet() bool {
	return v.isSet
}
...
func NewNullableDeleteLabelAlphaOutput(
	val *DeleteLabelAlphaOutput,
) *NullableDeleteLabelAlphaOutput {
	return &NullableDeleteLabelAlphaOutput{value: val, isSet: true}
}
