...
func (v *NullableRemoveSourceFromTrackingPlanV1Output) Set(val *RemoveSourceFromTrackingPlanV1Output) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRemoveSourceFromTrackingPlanV1Output(val *RemoveSourceFromTrackingPlanV1Output) *NullableRemoveSourceFromTrackingPlanV1Output {
