...
// checks if the DeleteSource200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteSource200Response{}
...
func NewDeleteSource200Response() *DeleteSource200Response {
	this := DeleteSource200Response{}
	return &this
}

// NewDeleteSource200ResponseWithDefaults instantiates a new DeleteSource200Response object
...
type NullableDeleteSource200Response struct {
	value *DeleteSource200Response
	isSet bool
}

func (v NullableDeleteSource200Response) Get() *DeleteSource200Response {
	return v.value
}

func (v *NullableDeleteSource200Response) Set(val *DeleteSource200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteSource200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteSource200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteSource200Response(
	val *DeleteSource200Response,
) *NullableDeleteSource200Response {
	return &NullableDeleteSource200Response{value: val, isSet: true}
}
