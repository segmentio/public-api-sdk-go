...
func (o *CreateFilterInput) GetProductArea() string {
...
// and a boolean to check if the value has been set.
func (o *CreateFilterInput) GetProductAreaOk() (*string, bool) {
	if o == nil || IsNil(o.ProductArea) {
		return nil, false
	}
...
func (o *CreateFilterInput) HasProductArea() bool {
	if o != nil && !IsNil(o.ProductArea) {
		return true
	}
...
func (o *CreateFilterInput) SetProductArea(v string) {
	o.ProductArea = &v
}
