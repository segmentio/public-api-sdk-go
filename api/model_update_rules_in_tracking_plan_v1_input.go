...
// checks if the UpdateRulesInTrackingPlanV1Input type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateRulesInTrackingPlanV1Input{}
