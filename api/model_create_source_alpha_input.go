...
func NewCreateSourceAlphaInput(slug string, enabled bool, metadataId string) *CreateSourceAlphaInput {
...
func NewNullableCreateSourceAlphaInput(val *CreateSourceAlphaInput) *NullableCreateSourceAlphaInput {
