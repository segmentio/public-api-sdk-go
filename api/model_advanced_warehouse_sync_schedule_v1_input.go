...
func NewAdvancedWarehouseSyncScheduleV1Input(times []WarehouseAdvancedSyncV1, timezone string) *AdvancedWarehouseSyncScheduleV1Input {
...
func (v *NullableAdvancedWarehouseSyncScheduleV1Input) Set(val *AdvancedWarehouseSyncScheduleV1Input) {
	v.value = val
	v.isSet = true
}
...
func NewNullableAdvancedWarehouseSyncScheduleV1Input(val *AdvancedWarehouseSyncScheduleV1Input) *NullableAdvancedWarehouseSyncScheduleV1Input {
