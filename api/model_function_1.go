...
// NewFunction1 instantiates a new Function1 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewFunction1() *Function1 {
	this := Function1{}
	return &this
}

// NewFunction1WithDefaults instantiates a new Function1 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewFunction1WithDefaults() *Function1 {
	this := Function1{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *Function1) GetId() string {
	if o == nil || o.Id == nil {
		var ret string
		return ret
	}
...
func (o *Function1) GetIdOk() (*string, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return o.Id, true
...
func (o *Function1) SetId(v string) {
	o.Id = &v
}

// GetResourceType returns the ResourceType field value if set, zero value otherwise.
func (o *Function1) GetResourceType() string {
...
// and a boolean to check if the value has been set.
func (o *Function1) GetResourceTypeOk() (*string, bool) {
	if o == nil || o.ResourceType == nil {
		return nil, false
	}
...
func (o *Function1) HasResourceType() bool {
	if o != nil && o.ResourceType != nil {
		return true
	}
...
func (o *Function1) SetResourceType(v string) {
	o.ResourceType = &v
}

// GetCreatedAt returns the CreatedAt field value if set, zero value otherwise.
func (o *Function1) GetCreatedAt() string {
...
// and a boolean to check if the value has been set.
func (o *Function1) GetCreatedAtOk() (*string, bool) {
	if o == nil || o.CreatedAt == nil {
		return nil, false
	}
...
func (o *Function1) HasCreatedAt() bool {
	if o != nil && o.CreatedAt != nil {
		return true
	}
...
func (o *Function1) SetCreatedAt(v string) {
	o.CreatedAt = &v
}

// GetCreatedBy returns the CreatedBy field value if set, zero value otherwise.
func (o *Function1) GetCreatedBy() string {
...
// and a boolean to check if the value has been set.
func (o *Function1) GetCreatedByOk() (*string, bool) {
	if o == nil || o.CreatedBy == nil {
		return nil, false
	}
...
func (o *Function1) HasCreatedBy() bool {
	if o != nil && o.CreatedBy != nil {
		return true
	}
...
func (o *Function1) SetCreatedBy(v string) {
	o.CreatedBy = &v
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *Function1) GetCode() string {
	if o == nil || o.Code == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Function1) GetCodeOk() (*string, bool) {
	if o == nil || o.Code == nil {
		return nil, false
	}
	return o.Code, true
...
func (o *Function1) GetDeployedAtOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Function1) HasDeployedAt() bool {
...
// and a boolean to check if the value has been set.
func (o *Function1) GetSettingsOk() ([]FunctionSettingV1, bool) {
	if o == nil || o.Settings == nil {
		return nil, false
	}
...
func (o *Function1) HasSettings() bool {
	if o != nil && o.Settings != nil {
		return true
	}
...
func (o *Function1) SetSettings(v []FunctionSettingV1) {
	o.Settings = v
}

// GetDisplayName returns the DisplayName field value if set, zero value otherwise.
func (o *Function1) GetDisplayName() string {
...
// and a boolean to check if the value has been set.
func (o *Function1) GetDisplayNameOk() (*string, bool) {
	if o == nil || o.DisplayName == nil {
		return nil, false
	}
...
func (o *Function1) HasDisplayName() bool {
	if o != nil && o.DisplayName != nil {
		return true
	}
...
func (o *Function1) SetDisplayName(v string) {
	o.DisplayName = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *Function1) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *Function1) GetDescriptionOk() (*string, bool) {
	if o == nil || o.Description == nil {
		return nil, false
	}
...
func (o *Function1) HasDescription() bool {
	if o != nil && o.Description != nil {
		return true
	}
...
func (o *Function1) SetDescription(v string) {
	o.Description = &v
}

// GetLogoUrl returns the LogoUrl field value if set, zero value otherwise.
func (o *Function1) GetLogoUrl() string {
...
// and a boolean to check if the value has been set.
func (o *Function1) GetLogoUrlOk() (*string, bool) {
	if o == nil || o.LogoUrl == nil {
		return nil, false
	}
...
func (o *Function1) HasLogoUrl() bool {
	if o != nil && o.LogoUrl != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Function1) GetPreviewWebhookUrlOk() (*string, bool) {
	if o == nil || o.PreviewWebhookUrl == nil {
		return nil, false
	}
...
func (o *Function1) HasPreviewWebhookUrl() bool {
	if o != nil && o.PreviewWebhookUrl != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Function1) GetBatchMaxCountOk() (*float32, bool) {
	if o == nil || o.BatchMaxCount == nil {
		return nil, false
	}
...
func (o *Function1) HasBatchMaxCount() bool {
	if o != nil && o.BatchMaxCount != nil {
		return true
	}
...
func (o *Function1) SetBatchMaxCount(v float32) {
	o.BatchMaxCount = &v
}

// GetCatalogId returns the CatalogId field value if set, zero value otherwise.
func (o *Function1) GetCatalogId() string {
...
// and a boolean to check if the value has been set.
func (o *Function1) GetCatalogIdOk() (*string, bool) {
	if o == nil || o.CatalogId == nil {
		return nil, false
	}
...
func (o *Function1) HasCatalogId() bool {
	if o != nil && o.CatalogId != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Function1) GetIsLatestVersionOk() (*bool, bool) {
	if o == nil || o.IsLatestVersion == nil {
		return nil, false
	}
...
func (o *Function1) HasIsLatestVersion() bool {
	if o != nil && o.IsLatestVersion != nil {
		return true
	}
...
func (o *Function1) SetIsLatestVersion(v bool) {
	o.IsLatestVersion = &v
}

func (o Function1) MarshalJSON() ([]byte, error) {
...
type NullableFunction1 struct {
	value *Function1
	isSet bool
}

func (v NullableFunction1) Get() *Function1 {
	return v.value
}

func (v *NullableFunction1) Set(val *Function1) {
	v.value = val
	v.isSet = true
}

func (v NullableFunction1) IsSet() bool {
	return v.isSet
}

func (v *NullableFunction1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFunction1(val *Function1) *NullableFunction1 {
	return &NullableFunction1{value: val, isSet: true}
}

func (v NullableFunction1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFunction1) UnmarshalJSON(src []byte) error {
	v.isSet = true
