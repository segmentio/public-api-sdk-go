...
func NewMtuSnapshotV1(periodStart float32, periodEnd float32, anonymous string, anonymousIdentified string, identified string, neverIdentified string, timestamp string) *MtuSnapshotV1 {
	this := MtuSnapshotV1{}
