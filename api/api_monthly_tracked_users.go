...
func (r ApiGetDailyPerSourceMTUUsageRequest) Period(period string) ApiGetDailyPerSourceMTUUsageRequest {
	r.period = &period
	return r
}

// Pagination input for per Source MTU counts.  This parameter exists in alpha.
func (r ApiGetDailyPerSourceMTUUsageRequest) Pagination(pagination PaginationInput) ApiGetDailyPerSourceMTUUsageRequest {
...
*/
func (a *MonthlyTrackedUsersApiService) GetDailyPerSourceMTUUsage(ctx context.Context) ApiGetDailyPerSourceMTUUsageRequest {
	return ApiGetDailyPerSourceMTUUsageRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MonthlyTrackedUsersApiService) GetDailyPerSourceMTUUsageExecute(r ApiGetDailyPerSourceMTUUsageRequest) (*GetDailyPerSourceMTUUsage200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MonthlyTrackedUsersApiService.GetDailyPerSourceMTUUsage")
	if err != nil {
...
// The start of the usage month, in the ISO-8601 format.  This parameter exists in alpha.
func (r ApiGetDailyWorkspaceMTUUsageRequest) Period(period string) ApiGetDailyWorkspaceMTUUsageRequest {
	r.period = &period
	return r
}

// Pagination input for Workspace MTU counts.  This parameter exists in alpha.
func (r ApiGetDailyWorkspaceMTUUsageRequest) Pagination(pagination PaginationInput) ApiGetDailyWorkspaceMTUUsageRequest {
	r.pagination = &pagination
	return r
}
...
*/
func (a *MonthlyTrackedUsersApiService) GetDailyWorkspaceMTUUsage(ctx context.Context) ApiGetDailyWorkspaceMTUUsageRequest {
	return ApiGetDailyWorkspaceMTUUsageRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MonthlyTrackedUsersApiService) GetDailyWorkspaceMTUUsageExecute(r ApiGetDailyWorkspaceMTUUsageRequest) (*GetDailyWorkspaceMTUUsage200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MonthlyTrackedUsersApiService.GetDailyWorkspaceMTUUsage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
