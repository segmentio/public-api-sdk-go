...
func NewWarehouseMetadata(id string, name string, slug string, description string, logos Logos2, options []IntegrationOptionV1) *WarehouseMetadata {
...
func (o *WarehouseMetadata) GetOptions() []IntegrationOptionV1 {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *WarehouseMetadata) GetOptionsOk() ([]IntegrationOptionV1, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WarehouseMetadata) SetOptions(v []IntegrationOptionV1) {
	o.Options = v
}
