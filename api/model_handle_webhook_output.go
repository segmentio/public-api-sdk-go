...
func NewHandleWebhookOutput(status string) *HandleWebhookOutput {
...
func (o *HandleWebhookOutput) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *HandleWebhookOutput) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *HandleWebhookOutput) SetStatus(v string) {
	o.Status = v
}
