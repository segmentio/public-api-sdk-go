...
func NewReplacePermissionsForUserV1Input() *ReplacePermissionsForUserV1Input {
...
func (o *ReplacePermissionsForUserV1Input) HasPermissions() bool {
	if o != nil && o.Permissions != nil {
		return true
	}
...
func NewNullableReplacePermissionsForUserV1Input(val *ReplacePermissionsForUserV1Input) *NullableReplacePermissionsForUserV1Input {
