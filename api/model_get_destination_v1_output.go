...
func NewGetDestinationV1Output(destination Destination) *GetDestinationV1Output {
...
func (o *GetDestinationV1Output) GetDestination() Destination {
	if o == nil {
		var ret Destination
		return ret
	}
...
func (o *GetDestinationV1Output) GetDestinationOk() (*Destination, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetDestinationV1Output) SetDestination(v Destination) {
	o.Destination = v
}
...
func NewNullableGetDestinationV1Output(val *GetDestinationV1Output) *NullableGetDestinationV1Output {
