...
func NewUpdateFilterForDestinationV1Output(filter Filter3) *UpdateFilterForDestinationV1Output {
...
func (o *UpdateFilterForDestinationV1Output) GetFilter() Filter3 {
	if o == nil {
		var ret Filter3
		return ret
	}
...
func (o *UpdateFilterForDestinationV1Output) GetFilterOk() (*Filter3, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UpdateFilterForDestinationV1Output) SetFilter(v Filter3) {
	o.Filter = v
}
...
func NewNullableUpdateFilterForDestinationV1Output(val *UpdateFilterForDestinationV1Output) *NullableUpdateFilterForDestinationV1Output {
