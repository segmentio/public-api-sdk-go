...
// Logos1 The logos for this Source.
type Logos1 struct {
...
// NewLogos1 instantiates a new Logos1 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewLogos1(default_ string) *Logos1 {
	this := Logos1{}
	this.Default = default_
	return &this
}

// NewLogos1WithDefaults instantiates a new Logos1 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewLogos1WithDefaults() *Logos1 {
	this := Logos1{}
	return &this
}

// GetDefault returns the Default field value
func (o *Logos1) GetDefault() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *Logos1) GetDefaultOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Logos1) GetMarkOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Logos1) GetAltOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
type NullableLogos1 struct {
	value *Logos1
	isSet bool
}

func (v NullableLogos1) Get() *Logos1 {
	return v.value
}

func (v *NullableLogos1) Set(val *Logos1) {
	v.value = val
	v.isSet = true
}

func (v NullableLogos1) IsSet() bool {
	return v.isSet
}

func (v *NullableLogos1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLogos1(val *Logos1) *NullableLogos1 {
	return &NullableLogos1{value: val, isSet: true}
}

func (v NullableLogos1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLogos1) UnmarshalJSON(src []byte) error {
	v.isSet = true
