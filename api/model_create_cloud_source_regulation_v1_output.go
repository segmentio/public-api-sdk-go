...
func NewCreateCloudSourceRegulationV1Output(regulateId string) *CreateCloudSourceRegulationV1Output {
...
func (v *NullableCreateCloudSourceRegulationV1Output) Set(val *CreateCloudSourceRegulationV1Output) {
	v.value = val
	v.isSet = true
}
...
func NewNullableCreateCloudSourceRegulationV1Output(val *CreateCloudSourceRegulationV1Output) *NullableCreateCloudSourceRegulationV1Output {
