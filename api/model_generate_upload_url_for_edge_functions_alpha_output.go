...
func NewGenerateUploadURLForEdgeFunctionsAlphaOutput(uploadURL string) *GenerateUploadURLForEdgeFunctionsAlphaOutput {
...
func (v *NullableGenerateUploadURLForEdgeFunctionsAlphaOutput) Set(val *GenerateUploadURLForEdgeFunctionsAlphaOutput) {
	v.value = val
	v.isSet = true
}
...
func NewNullableGenerateUploadURLForEdgeFunctionsAlphaOutput(val *GenerateUploadURLForEdgeFunctionsAlphaOutput) *NullableGenerateUploadURLForEdgeFunctionsAlphaOutput {
