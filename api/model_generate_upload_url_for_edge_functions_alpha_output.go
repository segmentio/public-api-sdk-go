...
// checks if the GenerateUploadURLForEdgeFunctionsAlphaOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenerateUploadURLForEdgeFunctionsAlphaOutput{}
