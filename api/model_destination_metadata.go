...
func (o *DestinationMetadata) GetOptions() []IntegrationOptionV1 {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *DestinationMetadata) GetOptionsOk() ([]IntegrationOptionV1, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DestinationMetadata) SetOptions(v []IntegrationOptionV1) {
	o.Options = v
}
