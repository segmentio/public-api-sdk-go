...
In the request body, the `subscriptionId` is the id that follows after /mappings/ in the URL of the mapping page.

For example, the `subscriptionId` would be `2` for this sync: https://.../example-workspace/reverse-etl/destinations/example-destination/sources/example-source/instances/1/mappings/2/source-id/3/model-id/4/sync-details
