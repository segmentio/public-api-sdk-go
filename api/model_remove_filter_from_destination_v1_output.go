...
func (v *NullableRemoveFilterFromDestinationV1Output) Set(val *RemoveFilterFromDestinationV1Output) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRemoveFilterFromDestinationV1Output(val *RemoveFilterFromDestinationV1Output) *NullableRemoveFilterFromDestinationV1Output {
