...
// Transformation The retrieved Transformation.
...
func NewTransformation(id string, name string, sourceId string, enabled bool, if_ string) *Transformation {
	this := Transformation{}
	this.Id = id
	this.Name = name
...
// NewTransformationWithDefaults instantiates a new Transformation object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTransformationWithDefaults() *Transformation {
	this := Transformation{}
	return &this
}
...
func (o *Transformation) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *Transformation) SetId(v string) {
	o.Id = v
}
...
func (o *Transformation) SetName(v string) {
	o.Name = v
}
...
// and a boolean to check if the value has been set.
func (o *Transformation) GetSourceIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Transformation) SetSourceId(v string) {
	o.SourceId = v
}
...
// and a boolean to check if the value has been set.
func (o *Transformation) GetDestinationMetadataIdOk() (*string, bool) {
	if o == nil || o.DestinationMetadataId == nil {
		return nil, false
	}
...
func (o *Transformation) HasDestinationMetadataId() bool {
	if o != nil && o.DestinationMetadataId != nil {
		return true
	}
...
func (o *Transformation) SetDestinationMetadataId(v string) {
...
// and a boolean to check if the value has been set.
func (o *Transformation) GetEnabledOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Transformation) SetEnabled(v bool) {
	o.Enabled = v
}
...
// and a boolean to check if the value has been set.
func (o *Transformation) GetIfOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.If, true
...
func (o *Transformation) SetIf(v string) {
	o.If = v
}
...
// and a boolean to check if the value has been set.
func (o *Transformation) GetNewEventNameOk() (*string, bool) {
	if o == nil || o.NewEventName == nil {
		return nil, false
	}
...
func (o *Transformation) HasNewEventName() bool {
	if o != nil && o.NewEventName != nil {
		return true
	}
...
func (o *Transformation) SetNewEventName(v string) {
	o.NewEventName = &v
}

// GetPropertyRenames returns the PropertyRenames field value if set, zero value otherwise.
func (o *Transformation) GetPropertyRenames() []PropertyRenameBeta {
...
// and a boolean to check if the value has been set.
func (o *Transformation) GetPropertyRenamesOk() ([]PropertyRenameBeta, bool) {
	if o == nil || o.PropertyRenames == nil {
		return nil, false
	}
...
func (o *Transformation) HasPropertyRenames() bool {
	if o != nil && o.PropertyRenames != nil {
		return true
	}
...
func (o *Transformation) SetPropertyRenames(v []PropertyRenameBeta) {
	o.PropertyRenames = v
}
