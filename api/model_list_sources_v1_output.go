...
func NewListSourcesV1Output(sources []SourceV1, pagination Pagination) *ListSourcesV1Output {
...
func (o *ListSourcesV1Output) GetPagination() Pagination {
	if o == nil {
		var ret Pagination
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListSourcesV1Output) GetPaginationOk() (*Pagination, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ListSourcesV1Output) SetPagination(v Pagination) {
	o.Pagination = v
}
