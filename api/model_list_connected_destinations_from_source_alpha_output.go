...
func NewListConnectedDestinationsFromSourceAlphaOutput(destinations []DestinationV1, pagination Pagination) *ListConnectedDestinationsFromSourceAlphaOutput {
...
func (v *NullableListConnectedDestinationsFromSourceAlphaOutput) Set(val *ListConnectedDestinationsFromSourceAlphaOutput) {
	v.value = val
	v.isSet = true
}
...
func NewNullableListConnectedDestinationsFromSourceAlphaOutput(val *ListConnectedDestinationsFromSourceAlphaOutput) *NullableListConnectedDestinationsFromSourceAlphaOutput {
