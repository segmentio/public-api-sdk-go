...
func NewMessagesSubscriptionRequest(key string, type_ string, status string) *MessagesSubscriptionRequest {
...
func NewNullableMessagesSubscriptionRequest(val *MessagesSubscriptionRequest) *NullableMessagesSubscriptionRequest {
