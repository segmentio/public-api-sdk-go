...
func NewMetadata1(id string, name string, slug string, description string, logos Logos1, options []IntegrationOptionV1, categories []string, isCloudEventSource bool) *Metadata1 {
	this := Metadata1{}
	this.Id = id
	this.Name = name
	this.Slug = slug
...
func (o *Metadata1) GetOptions() []IntegrationOptionV1 {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *Metadata1) GetOptionsOk() ([]IntegrationOptionV1, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Metadata1) SetOptions(v []IntegrationOptionV1) {
	o.Options = v
}
