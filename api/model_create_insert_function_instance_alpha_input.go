...
func (o *CreateInsertFunctionInstanceAlphaInput) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateInsertFunctionInstanceAlphaInput) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *CreateInsertFunctionInstanceAlphaInput) SetType(v string) {
	o.Type = v
}
