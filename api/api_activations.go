...
type ApiBatchQueryActivationsForSpaceRequest struct {
	ctx                                     context.Context
	ApiService                              *ActivationsAPIService
	spaceId                                 string
...
func (r ApiBatchQueryActivationsForSpaceRequest) BatchQueryActivationsForSpaceAlphaInput(
	batchQueryActivationsForSpaceAlphaInput BatchQueryActivationsForSpaceAlphaInput,
) ApiBatchQueryActivationsForSpaceRequest {
	r.batchQueryActivationsForSpaceAlphaInput = &batchQueryActivationsForSpaceAlphaInput
	return r
}

func (r ApiBatchQueryActivationsForSpaceRequest) Execute() (*BatchQueryActivationsForSpace200Response, *http.Response, error) {
	return r.ApiService.BatchQueryActivationsForSpaceExecute(r)
}

/*
BatchQueryActivationsForSpace Batch Query Activations for Space

Lists Activations in bulk across many Audiences in one call. Intended for bulk reads, for example pulling activation metadata for hundreds of audiences on a schedule, so callers don't need one `listActivationsFromAudience` call per audience.
...
The rate limit for this endpoint is 60 requests per minute, which is lower than the default due to access pattern restrictions. Once reached, this endpoint will respond with the 429 HTTP status code with headers indicating the limit parameters. See [Rate Limiting](/#tag/Rate-Limits) for more information.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param spaceId
	@return ApiBatchQueryActivationsForSpaceRequest
*/
func (a *ActivationsAPIService) BatchQueryActivationsForSpace(
	ctx context.Context,
	spaceId string,
) ApiBatchQueryActivationsForSpaceRequest {
	return ApiBatchQueryActivationsForSpaceRequest{
...
func (a *ActivationsAPIService) BatchQueryActivationsForSpaceExecute(
	r ApiBatchQueryActivationsForSpaceRequest,
) (*BatchQueryActivationsForSpace200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *BatchQueryActivationsForSpace200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(
		r.ctx,
		"ActivationsAPIService.BatchQueryActivationsForSpace",
	)
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/spaces/{spaceId}/activations/batch"
	localVarPath = strings.Replace(
		localVarPath,
		"{"+"spaceId"+"}",
		url.PathEscape(parameterValueToString(r.spaceId, "spaceId")),
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.batchQueryActivationsForSpaceAlphaInput == nil {
		return localVarReturnValue, nil, reportError(
			"batchQueryActivationsForSpaceAlphaInput is required and must be specified",
		)
	}
	...
	// body params
	localVarPostBody = r.batchQueryActivationsForSpaceAlphaInput
	req, err := a.client.prepareRequest(
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
...
type ApiUpdateDestinationForAudienceRequest struct {
	ctx                                    context.Context
	ApiService                             *ActivationsAPIService
	spaceId                                string
	audienceId                             string
...
func (r ApiUpdateDestinationForAudienceRequest) UpdateDestinationForAudienceAlphaInput(
	updateDestinationForAudienceAlphaInput UpdateDestinationForAudienceAlphaInput,
) ApiUpdateDestinationForAudienceRequest {
	r.updateDestinationForAudienceAlphaInput = &updateDestinationForAudienceAlphaInput
	return r
}

func (r ApiUpdateDestinationForAudienceRequest) Execute() (*UpdateDestinationForAudience200Response, *http.Response, error) {
	return r.ApiService.UpdateDestinationForAudienceExecute(r)
}

/*
UpdateDestinationForAudience Update Destination for Audience
...
• In order to successfully call this endpoint, the specified Workspace needs to have the Audience feature enabled. Please reach out to your customer success manager for more information.
	...
	@param audienceId
	@param destinationId
	@return ApiUpdateDestinationForAudienceRequest
*/
func (a *ActivationsAPIService) UpdateDestinationForAudience(
	ctx context.Context,
	spaceId string,
	audienceId string,
	destinationId string,
...
func (a *ActivationsAPIService) UpdateDestinationForAudienceExecute(
	r ApiUpdateDestinationForAudienceRequest,
) (*UpdateDestinationForAudience200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateDestinationForAudience200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(
		r.ctx,
		"ActivationsAPIService.UpdateDestinationForAudience",
	)
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateDestinationForAudienceAlphaInput == nil {
		return localVarReturnValue, nil, reportError(
			"updateDestinationForAudienceAlphaInput is required and must be specified",
		)
	}
	...
	// body params
	localVarPostBody = r.updateDestinationForAudienceAlphaInput
	req, err := a.client.prepareRequest(
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
