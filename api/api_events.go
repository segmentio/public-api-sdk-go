...
*/
func (a *EventsApiService) GetEventsVolumeFromWorkspace(ctx context.Context) ApiGetEventsVolumeFromWorkspaceRequest {
	return ApiGetEventsVolumeFromWorkspaceRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *EventsApiService) GetEventsVolumeFromWorkspaceExecute(r ApiGetEventsVolumeFromWorkspaceRequest) (*GetEventsVolumeFromWorkspace200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EventsApiService.GetEventsVolumeFromWorkspace")
	if err != nil {
