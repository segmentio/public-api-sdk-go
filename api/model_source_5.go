...
func NewSource5(id string, slug string, metadata Metadata1, workspaceId string, enabled bool, writeKeys []string, labels []LabelV1) *Source5 {
	this := Source5{}
	this.Id = id
	this.Slug = slug
...
func (o *Source5) GetMetadata() Metadata1 {
	if o == nil {
		var ret Metadata1
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Source5) GetMetadataOk() (*Metadata1, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Source5) SetMetadata(v Metadata1) {
	o.Metadata = v
}
