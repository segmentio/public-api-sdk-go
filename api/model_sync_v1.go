...
func NewSyncV1(sourceId string, start string, end NullableString, status string, duration float32, humanDuration string, count float32, notices []SyncNoticeV1) *SyncV1 {
	this := SyncV1{}
