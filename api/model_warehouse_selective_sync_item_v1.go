...
func NewWarehouseSelectiveSyncItemV1(sourceId string, collection string, warehouseId string, properties map[string]interface{}) *WarehouseSelectiveSyncItemV1 {
...
func NewNullableWarehouseSelectiveSyncItemV1(val *WarehouseSelectiveSyncItemV1) *NullableWarehouseSelectiveSyncItemV1 {
