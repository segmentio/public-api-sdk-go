...
// APIClient manages communication with the Segment Public API API v53.2.1
...
type APIClient struct {
	...
	PersonalizationAPI *PersonalizationAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.PersonalizationAPI = (*PersonalizationAPIService)(&c.common)
