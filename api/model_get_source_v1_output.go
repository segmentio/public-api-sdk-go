...
func NewGetSourceV1Output(source Source1) *GetSourceV1Output {
...
func (o *GetSourceV1Output) GetSource() Source1 {
	if o == nil {
		var ret Source1
		return ret
	}
...
func (o *GetSourceV1Output) GetSourceOk() (*Source1, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetSourceV1Output) SetSource(v Source1) {
	o.Source = v
}
