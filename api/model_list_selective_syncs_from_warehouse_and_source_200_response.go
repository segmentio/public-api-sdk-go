...
// checks if the ListSelectiveSyncsFromWarehouseAndSource200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListSelectiveSyncsFromWarehouseAndSource200Response{}
...
func (o ListSelectiveSyncsFromWarehouseAndSource200Response) ToMap() (map[string]interface{}, error) {
