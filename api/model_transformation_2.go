...
// Transformation2 The created Transformation.
type Transformation2 struct {
...
// NewTransformation2 instantiates a new Transformation2 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTransformation2(id string, name string, sourceId string, enabled bool, if_ string) *Transformation2 {
...
// NewTransformation2WithDefaults instantiates a new Transformation2 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTransformation2WithDefaults() *Transformation2 {
	this := Transformation2{}
	return &this
}

// GetId returns the Id field value
func (o *Transformation2) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *Transformation2) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *Transformation2) SetId(v string) {
	o.Id = v
}

// GetName returns the Name field value
func (o *Transformation2) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Transformation2) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *Transformation2) SetName(v string) {
	o.Name = v
}

// GetSourceId returns the SourceId field value
func (o *Transformation2) GetSourceId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Transformation2) GetSourceIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Transformation2) GetDestinationMetadataIdOk() (*string, bool) {
	if o == nil || o.DestinationMetadataId == nil {
		return nil, false
	}
...
func (o *Transformation2) HasDestinationMetadataId() bool {
	if o != nil && o.DestinationMetadataId != nil {
		return true
	}
...
func (o *Transformation2) SetDestinationMetadataId(v string) {
	o.DestinationMetadataId = &v
}

// GetEnabled returns the Enabled field value
func (o *Transformation2) GetEnabled() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Transformation2) GetEnabledOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Transformation2) SetEnabled(v bool) {
	o.Enabled = v
}

// GetIf returns the If field value
func (o *Transformation2) GetIf() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Transformation2) GetIfOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.If, true
...
func (o *Transformation2) SetIf(v string) {
	o.If = v
}

// GetNewEventName returns the NewEventName field value if set, zero value otherwise.
func (o *Transformation2) GetNewEventName() string {
...
// and a boolean to check if the value has been set.
func (o *Transformation2) GetNewEventNameOk() (*string, bool) {
	if o == nil || o.NewEventName == nil {
		return nil, false
	}
...
func (o *Transformation2) HasNewEventName() bool {
	if o != nil && o.NewEventName != nil {
		return true
	}
...
func (o *Transformation2) SetNewEventName(v string) {
	o.NewEventName = &v
}

// GetPropertyRenames returns the PropertyRenames field value if set, zero value otherwise.
func (o *Transformation2) GetPropertyRenames() []PropertyRenameBeta {
...
// and a boolean to check if the value has been set.
func (o *Transformation2) GetPropertyRenamesOk() ([]PropertyRenameBeta, bool) {
	if o == nil || o.PropertyRenames == nil {
		return nil, false
	}
...
func (o *Transformation2) HasPropertyRenames() bool {
	if o != nil && o.PropertyRenames != nil {
		return true
	}
...
func (o *Transformation2) SetPropertyRenames(v []PropertyRenameBeta) {
	o.PropertyRenames = v
}

// GetPropertyValueTransformations returns the PropertyValueTransformations field value if set, zero value otherwise.
func (o *Transformation2) GetPropertyValueTransformations() []PropertyValueTransformationBeta {
...
// and a boolean to check if the value has been set.
func (o *Transformation2) GetPropertyValueTransformationsOk() ([]PropertyValueTransformationBeta, bool) {
	if o == nil || o.PropertyValueTransformations == nil {
		return nil, false
	}
...
func (o *Transformation2) HasPropertyValueTransformations() bool {
	if o != nil && o.PropertyValueTransformations != nil {
		return true
	}
...
func (o *Transformation2) SetPropertyValueTransformations(v []PropertyValueTransformationBeta) {
	o.PropertyValueTransformations = v
}

func (o Transformation2) MarshalJSON() ([]byte, error) {
...
type NullableTransformation2 struct {
	value *Transformation2
	isSet bool
}

func (v NullableTransformation2) Get() *Transformation2 {
	return v.value
}

func (v *NullableTransformation2) Set(val *Transformation2) {
	v.value = val
	v.isSet = true
}

func (v NullableTransformation2) IsSet() bool {
	return v.isSet
}

func (v *NullableTransformation2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransformation2(val *Transformation2) *NullableTransformation2 {
	return &NullableTransformation2{value: val, isSet: true}
}

func (v NullableTransformation2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransformation2) UnmarshalJSON(src []byte) error {
	v.isSet = true
