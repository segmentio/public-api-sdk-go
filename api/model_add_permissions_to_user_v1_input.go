...
func NewAddPermissionsToUserV1Input() *AddPermissionsToUserV1Input {
...
func (o *AddPermissionsToUserV1Input) HasPermissions() bool {
	if o != nil && o.Permissions != nil {
		return true
	}
...
func NewNullableAddPermissionsToUserV1Input(val *AddPermissionsToUserV1Input) *NullableAddPermissionsToUserV1Input {
