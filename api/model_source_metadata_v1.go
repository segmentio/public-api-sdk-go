...
func NewSourceMetadataV1(id string, name string, slug string, description string, logos Logos1, options []IntegrationOptionV1, categories []string, isCloudEventSource bool) *SourceMetadataV1 {
...
func (o *SourceMetadataV1) GetOptions() []IntegrationOptionV1 {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *SourceMetadataV1) GetOptionsOk() ([]IntegrationOptionV1, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SourceMetadataV1) SetOptions(v []IntegrationOptionV1) {
	o.Options = v
}
