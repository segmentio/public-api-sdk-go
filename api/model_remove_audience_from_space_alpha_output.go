...
// checks if the RemoveAudienceFromSpaceAlphaOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoveAudienceFromSpaceAlphaOutput{}
